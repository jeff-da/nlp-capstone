...
objs = [json.loads(line) for line in open("/home/jzda/nlvr/nlvr2/data/train.json").readlines()]

outfile = open("/home/jzda/nlp-capstone/dan/object_features_train_cuda.txt", "w")

def get_left_link(identifier, directory):
    if 'directory' is not None: # training image
        return "/home/jzda/images/train/" + str(directory) + "/" + str(identifier)[:-2] + "-img0.png"
    else: # dev image
        return "/home/jzda/images/dev/" + str(identifier)[:-2] + "-img0.png"

def get_right_link(identifier, directory):
    if 'directory' is not None: # training image
        return "/home/jzda/images/train/" + str(directory) + "/" + str(identifier)[:-2] + "-img1.png"
    else: # dev image
        return "/home/jzda/images/dev/" + str(identifier)[:-2] + "-img1.png"

config_file = "/home/jzda/nlp-capstone/dan/maskrcnn-benchmark/configs/caffe2/e2e_mask_rcnn_R_50_FPN_1x_caffe2.yaml"
